...
public class PlacesInBaggingAreaTest {
	...
	@Test
	public void testPlaceItem_Enabled() {
		//create test station
		Currency testCurrency = Currency.getInstance("CAD");
		int[] testBanknoteDenomnations = {1,2,5};
		BigDecimal[] testCoinDenomnations = {BigDecimal.TEN};
		...
		//place item through console
		testConsole.checkoutStation.baggingArea.enable();
		testConsole.placeItem(testItem);
	...
	@Test
	public void testPlaceItem_Disabled() {
		//create test station
		Currency testCurrency = Currency.getInstance("CAD");
		int[] testBanknoteDenomnations = {1,2,5};
		BigDecimal[] testCoinDenomnations = {BigDecimal.TEN};
		...
		//place item through console
		testConsole.checkoutStation.baggingArea.disable();
		testConsole.placeItem(testItem);
	...
	@Test
	public void testRemoveItem_overloadRemoved() {
		//create test station
		Currency testCurrency = Currency.getInstance("CAD");
		int[] testBanknoteDenomnations = {1,2,5};
		BigDecimal[] testCoinDenomnations = {BigDecimal.TEN};
		...
		//create test item
		Barcode testBarcode = new Barcode("0001");
		Item testItem = new BarcodedItem(testBarcode, 1000);	
		
		//place item through console
		
		testConsole.placeItem(testItem);
		testConsole.removeItem(testItem);
